...
def getMinedEther():
    ...
    #         # print trTime
    #         break
    res = requests.get("http://ethereum.miningpoolhub.com/index.php?page=api&action=getdashboarddata&api_key=a8c9f5ea1a4045f6809c9a47c4746f5ae4aa5e136bf96ec0ce4223734c96a128")
    netValue = res.json()["getdashboarddata"]["data"]["recent_credits_24hours"]["amount"]
...
def getMinedEtc():
    ...
    #
    # netValue = sum(credits) - sum(fee)
    res = requests.get("http://ethereum-classic.miningpoolhub.com/index.php?page=api&action=getdashboarddata&api_key=a8c9f5ea1a4045f6809c9a47c4746f5ae4aa5e136bf96ec0ce4223734c96a128")
    netValue = res.json()["getdashboarddata"]["data"]["recent_credits_24hours"]["amount"]
    return netValue
