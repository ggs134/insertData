...
average_list3 = [ i["average_temp"] for i in data3 ]
total_average_list = average_list1 + average_list2 + average_list3
...
average3 = sum(average_list2) / float(len(average_list2))
...
mongoDB["statusData3"].insert({"data": data3})
